...
describe('Test the Booking Mutation', () => {
    it('should not execute booking mutation without authorization', async () => {
   ...
   `;
    ...
    it('should execute booking mutation with authorization', async () => {
        const postScheduleFlight = gql`
      mutation ScheduleFlight {
          scheduleFlight(flightInfo: {launchSiteId: "7c17eec7-6b8c-4683-b556-a997bd2eff65",landingSiteId: "a283632c-c701-4827-9375-ae6fb3445ca9", departureAt: "2022-05-07", seatCount: 200}) {
              code
...
describe('Test the Booking Query', () => {
    it('should not execute booking query without authorization', async () => {
    ...
    it('should execute booking query with authorization', async () => {
        const getFlights = gql`
      query Flights {
